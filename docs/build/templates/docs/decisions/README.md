...
Format: one file, `<YYYY-MM-DD>-<slug>.md` (coordination-free, per atelier's
`method/CONCURRENCY.md` record-identifier rule; legacy `NNNN` files keep
...
`[2026-01-15](2026-01-15-slug.md) — one-line summary of the decision` -->
