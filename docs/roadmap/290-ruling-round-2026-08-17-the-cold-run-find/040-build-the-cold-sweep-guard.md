- [ ] 🎯 **RULED 2026-08-17 — "Build a guard."** The cold-sweep exclusion
      ...
      - [ ] Build it: the correct exclusion becomes the **default** and a bare
      ...
      - [ ] Grounding, not invention: the barred set is `REVIEW.md` rule 2's,
            and the three recorded instances are its test corpus.
      - [ ] First-of-kind build — queue its own rule-4 `⏳` at landing.
