...
Don't ask me things doctrine already answers; use AskUserQuestion for
what's genuinely mine to decide.
...
Close per doctrine, then: summarise what happened, give me your session ID
(`$CLAUDE_CODE_SESSION_ID`) for `cctranscript`, walk me through anything
still open, and confirm nothing's left uncaptured.
