...
- [ ] [REPORT — the read-the-output rule covers an unread check and not an…](roadmap/320-child-filed-findings-via-pointing-up/160-read-the-output-does-not-say-verify-the-act-happened.md)
