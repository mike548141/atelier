- ⏳ **Rule-4 cold pass queued — the naming precedence: rule 2 governs every
      ...
      takes. *Pass type:* doctrine cold pass, per `method/REVIEW.md` rule 4.
      *Delta — scoped to paths:* `docs/method/PROPAGATION.md` § *The route*
      rule 2 (the precedence paragraph) and § *Report without harming the
      parent* (its first two bullets — the branch form and what the commit
      and PR may say). Landed on `main`, 2026-09-20.
      ...
      *Intent record:*
      ...
      `docs/reviews/2026-09-25-0715-naming-precedence-cold.md`) by a Mike-opened
      ...
      - [ ] 🎯 **The pass RAN 2026-09-26; the cycle CLOSES on this pass (no
            ...
            PASS-WITH-FINDINGS — 0 MAJOR · 3 MODERATE · 4 minor · 3 note →
            [`2026-09-25-0715-naming-precedence-cold.md`](../../reviews/2026-09-25-0715-naming-precedence-cold.md)
            (sibling folded in and deleted). NP2/NP6 (MODERATE): the precedence
            is prose-only on all four published surfaces — no hook or scanner
            reads a branch name, commit subject or PR title, and blockscan keys
            the ## heading while the delta edited ### subsections; NP1/NP5
            sharpened at reconcile as the applier's wording beyond the recorded
            ruling; NP10 (minor) formed at reconcile. Findings are the
