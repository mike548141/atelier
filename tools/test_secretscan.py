...
class LinkedWorktreeSkipped(unittest.TestCase):
    ...
    2026-08-15: a whole-repo run reported findings once for the tree and
    once per live worktree, and `leakscan .` blocked a commit on 101
    findings already covered by `.leakscanignore` one layer up)."""
