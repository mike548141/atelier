...
### Added (2026-08-04 — the queued-review pointer gets a forcing function, and the deletion guard gets wired)
...
### Changed (2026-08-04 — B4's shelf verdict overturned; `harvestscan` joins the registry)
